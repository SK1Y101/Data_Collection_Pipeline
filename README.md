...
During the downtime, the cron script searches for any updates to the docker scripts, updates that are automatically generated by a github action when a pull request is made to the main branch. (The action is still a WiP)
